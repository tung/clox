...
SourceToDump varGet[] = {
  ...
  { true, "foo + bar + foo + bar;",
      "== <script> ==\n"
      "0000    1 OP_GET_GLOBAL       0 'foo'\n"
      "0002    | OP_GET_GLOBAL       1 'bar'\n"
      "0004    | OP_ADD\n"
      "0005    | OP_GET_GLOBAL       0 'foo'\n"
      "0007    | OP_ADD\n"
      "0008    | OP_GET_GLOBAL       1 'bar'\n"
      "0010    | OP_ADD\n"
      "0011    | OP_POP\n"
      "0012    | OP_NIL\n"
      "0013    | OP_RETURN\n" },
...
SourceToDump functions[] = {
  ...
  { true, "fun a(x,y){return x+y;}print a(3,a(2,1));",
      ...
      "0008    | OP_GET_GLOBAL       0 'a'\n"
      "0010    | OP_CONSTANT         3 '2'\n"
      "0012    | OP_CONSTANT         4 '1'\n"
      "0014    | OP_CALL             2\n"
      "0016    | OP_CALL             2\n"
      "0018    | OP_PRINT\n"
      "0019    | OP_NIL\n"
...
SourceToDump closures[] = {
  { true,
      ...
      "0012    | OP_GET_GLOBAL       2 'c'\n"
      "0014    | OP_CALL             0\n"
      "0016    | OP_POP\n"
      "0017    | OP_GET_GLOBAL       2 'c'\n"
      "0019    | OP_CALL             0\n"
      "0021    | OP_POP\n"
      "0022    | OP_GET_GLOBAL       2 'c'\n"
      "0024    | OP_CALL             0\n"
      "0026    | OP_POP\n"
      "0027    | OP_NIL\n"
      "0028    | OP_RETURN\n" },
  ...
  { true,
      ...
      "0023    | OP_POP\n"
      "0024    | OP_CLOSURE          7 <fn gg>\n"
      "0026      |                     local 1\n"
      "0028    | OP_GET_LOCAL        5\n"
      "0030    | OP_SET_GLOBAL       1 'g'\n"
      "0032    | OP_POP\n"
      "0033    | OP_CLOSURE          8 <fn hh>\n"
      "0035      |                     local 2\n"
      "0037    | OP_GET_LOCAL        6\n"
      "0039    | OP_SET_GLOBAL       2 'h'\n"
      "0041    | OP_POP\n"
      "0042    | OP_POP\n"
      "0043    | OP_POP\n"
      "0044    | OP_POP\n"
      ...
      "0048    | OP_GET_GLOBAL       0 'f'\n"
      "0050    | OP_CALL             0\n"
      "0052    | OP_POP\n"
      "0053    | OP_GET_GLOBAL       1 'g'\n"
      "0055    | OP_CALL             0\n"
      "0057    | OP_POP\n"
      "0058    | OP_GET_GLOBAL       2 'h'\n"
      "0060    | OP_CALL             0\n"
      "0062    | OP_POP\n"
      "0063    | OP_NIL\n"
      "0064    | OP_RETURN\n" },
...
SourceToDump classes[] = {
  ...
  { true, "class F{}var f=F();f.x=1;print f.x;",
      ...
      "0004    | OP_GET_GLOBAL       0 'F'\n"
      "0006    | OP_POP\n"
      "0007    | OP_GET_GLOBAL       0 'F'\n"
      "0009    | OP_CALL             0\n"
      "0011    | OP_DEFINE_GLOBAL    1 'f'\n"
      "0013    | OP_GET_GLOBAL       1 'f'\n"
      "0015    | OP_CONSTANT         3 '1'\n"
      "0017    | OP_SET_PROPERTY     2 'x'\n"
      "0019    | OP_POP\n"
      "0020    | OP_GET_GLOBAL       1 'f'\n"
      "0022    | OP_GET_PROPERTY     2 'x'\n"
      "0024    | OP_PRINT\n"
      "0025    | OP_NIL\n"
      "0026    | OP_RETURN\n" },
...
SourceToDump methods[] = {
  ...
  { true, "class F{inin(){return 0;}}",
      ...
      "0002    | OP_DEFINE_GLOBAL    0 'F'\n"
      "0004    | OP_GET_GLOBAL       0 'F'\n"
      "0006    | OP_CONSTANT         2 '<fn inin>'\n"
      "0008    | OP_METHOD           1 'inin'\n"
      "0010    | OP_POP\n"
      "0011    | OP_NIL\n"
      "0012    | OP_RETURN\n" },
  { true,
      ...
      "0002    | OP_DEFINE_GLOBAL    0 'F'\n"
      "0004    | OP_GET_GLOBAL       0 'F'\n"
      "0006    | OP_CONSTANT         2 '<fn init>'\n"
      "0008    | OP_METHOD           1 'init'\n"
      "0010    | OP_CONSTANT         4 '<fn get>'\n"
      "0012    | OP_METHOD           3 'get'\n"
      "0014    | OP_CONSTANT         6 '<fn set>'\n"
      "0016    | OP_METHOD           5 'set'\n"
      "0018    | OP_POP\n"
      "0019    | OP_GET_GLOBAL       0 'F'\n"
      "0021    | OP_CONSTANT         8 '1'\n"
      "0023    | OP_CALL             1\n"
      "0025    | OP_DEFINE_GLOBAL    7 'f'\n"
      "0027    | OP_GET_GLOBAL       7 'f'\n"
      "0029    | OP_INVOKE        (0 args)    3 'get'\n"
      "0032    | OP_PRINT\n"
      "0033    | OP_GET_GLOBAL       7 'f'\n"
      "0035    | OP_CONSTANT         9 '2'\n"
      "0037    | OP_INVOKE        (1 args)    5 'set'\n"
      "0040    | OP_POP\n"
      "0041    | OP_GET_GLOBAL       7 'f'\n"
      "0043    | OP_INVOKE        (0 args)    3 'get'\n"
      "0046    | OP_PRINT\n"
      "0047    | OP_GET_GLOBAL       7 'f'\n"
      "0049    | OP_GET_PROPERTY     3 'get'\n"
      "0051    | OP_DEFINE_GLOBAL   10 'g'\n"
      "0053    | OP_GET_GLOBAL       7 'f'\n"
      "0055    | OP_GET_PROPERTY     5 'set'\n"
      "0057    | OP_DEFINE_GLOBAL   11 's'\n"
      "0059    | OP_GET_GLOBAL      10 'g'\n"
      "0061    | OP_CALL             0\n"
      "0063    | OP_PRINT\n"
      "0064    | OP_GET_GLOBAL      11 's'\n"
      "0066    | OP_CONSTANT        12 '3'\n"
      "0068    | OP_CALL             1\n"
      "0070    | OP_POP\n"
      "0071    | OP_GET_GLOBAL      10 'g'\n"
      "0073    | OP_CALL             0\n"
      "0075    | OP_PRINT\n"
      "0076    | OP_NIL\n"
      "0077    | OP_RETURN\n" },
