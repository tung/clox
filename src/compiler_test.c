...
SourceToDump classes[] = {
  ...
  { true, "class F{}var f=F();f.x=1;print f.x;",
      ...
      "0004    | OP_GET_GLOBAL       1 'F'\n"
      "0006    | OP_POP\n"
      "0007    | OP_GET_GLOBAL       3 'F'\n"
      "0009    | OP_CALL             0\n"
      "0011    | OP_DEFINE_GLOBAL    2 'f'\n"
      "0013    | OP_GET_GLOBAL       4 'f'\n"
      "0015    | OP_CONSTANT         6 '1'\n"
      "0017    | OP_SET_PROPERTY     5 'x'\n"
      "0019    | OP_POP\n"
      "0020    | OP_GET_GLOBAL       7 'f'\n"
      "0022    | OP_GET_PROPERTY     8 'x'\n"
      "0024    | OP_PRINT\n"
      "0025    | OP_NIL\n"
      "0026    | OP_RETURN\n" },
...
SourceToDump methods[] = {
  ...
  { true, "class F{inin(){return 0;}}",
      ...
      "0002    | OP_DEFINE_GLOBAL    0 'F'\n"
      "0004    | OP_GET_GLOBAL       1 'F'\n"
      "0006    | OP_CONSTANT         3 '<fn inin>'\n"
      "0008    | OP_METHOD           2 'inin'\n"
      "0010    | OP_POP\n"
      "0011    | OP_NIL\n"
      "0012    | OP_RETURN\n" },
  { true,
      ...
      "0002    | OP_DEFINE_GLOBAL    0 'F'\n"
      "0004    | OP_GET_GLOBAL       1 'F'\n"
      "0006    | OP_CONSTANT         3 '<fn init>'\n"
      "0008    | OP_METHOD           2 'init'\n"
      "0010    | OP_CONSTANT         5 '<fn get>'\n"
      "0012    | OP_METHOD           4 'get'\n"
      "0014    | OP_CONSTANT         7 '<fn set>'\n"
      "0016    | OP_METHOD           6 'set'\n"
      "0018    | OP_POP\n"
      "0019    | OP_GET_GLOBAL       9 'F'\n"
      "0021    | OP_CONSTANT        10 '1'\n"
      "0023    | OP_CALL             1\n"
      "0025    | OP_DEFINE_GLOBAL    8 'f'\n"
      "0027    | OP_GET_GLOBAL      11 'f'\n"
      "0029    | OP_INVOKE        (0 args)   12 'get'\n"
      "0032    | OP_PRINT\n"
      "0033    | OP_GET_GLOBAL      13 'f'\n"
      "0035    | OP_CONSTANT        15 '2'\n"
      "0037    | OP_INVOKE        (1 args)   14 'set'\n"
      "0040    | OP_POP\n"
      "0041    | OP_GET_GLOBAL      16 'f'\n"
      "0043    | OP_INVOKE        (0 args)   17 'get'\n"
      "0046    | OP_PRINT\n"
      "0047    | OP_GET_GLOBAL      19 'f'\n"
      "0049    | OP_GET_PROPERTY    20 'get'\n"
      "0051    | OP_DEFINE_GLOBAL   18 'g'\n"
      "0053    | OP_GET_GLOBAL      22 'f'\n"
      "0055    | OP_GET_PROPERTY    23 'set'\n"
      "0057    | OP_DEFINE_GLOBAL   21 's'\n"
      "0059    | OP_GET_GLOBAL      24 'g'\n"
      "0061    | OP_CALL             0\n"
      "0063    | OP_PRINT\n"
      "0064    | OP_GET_GLOBAL      25 's'\n"
      "0066    | OP_CONSTANT        26 '3'\n"
      "0068    | OP_CALL             1\n"
      "0070    | OP_POP\n"
      "0071    | OP_GET_GLOBAL      27 'g'\n"
      "0073    | OP_CALL             0\n"
      "0075    | OP_PRINT\n"
      "0076    | OP_NIL\n"
      "0077    | OP_RETURN\n" },
